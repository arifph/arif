...
<head>
	...
	<script type="text/javascript">
		$(document).ready(function(){
			...
			var wrapper = $('.field_wrappper');
			var fieldHTML = '<div class="form-line"><input type="text" name="field_name[]" class="form-control" placeholder="Masukkan Nama Lokasi Terdekat" value=""></div>';
                        ...
                        <div class="body">
                            <form class="form-horizontal" action="../controller/c_submit.php" method="POST" enctype="multipart/form-data">
								...
								<div class="row clearfix">
                                    ...
                                    <div class="col-lg-9 col-md-10 col-sm-8 col-xs-7">
                                        <div class="form-group">
											<div class="field_wrappper">
												<div class="form-line">
													<!--input type="text" id="dekat" name="dekat" class="form-control" placeholder="Masukkan Nama Lokasi Terdekat" value=""-->
													<input type="text" name="field_name[]" class="form-control" placeholder="Masukkan Nama Lokasi Terdekat" value="">
													<!--a href="javascript:void(0);" class="add_button" title="Tambah Lokasi Terdekat">Tambah Lokasi Terdekat</a-->
												</div>
                                            </div>
                                        </div>
                                    </div>
							...
							<div class="row clearfix">
								<div class="col-lg-offset-9 col-md-offset-2 col-sm-offset-4 col-xs-offset-5">
									<!--button type="submit" id="tambah" name="tambah" onclick="tambahBaris()" class="btn bg-green m-t-15 waves-effect">Tambah Lokasi</button-->
									<button type="submit" id="tambah" name="tambah" class="btn bg-green m-t-15 waves-effect add_button">Tambah Lokasi Terdekat</button>
								</div>
							</div>
                        </div>
					</div>
